...
public class UpdateItems extends javax.swing.JFrame {
    ...
    //Creating a new form UpdateItems in UpdatesItems class
    public UpdateItems() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Update Items Details");
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 190, -1, -1));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 190, -1, -1));

        jButton5.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jButton5.setForeground(new java.awt.Color(153, 153, 0));
        jButton5.setText("Search Item Details");
        jButton5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton5ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, -1, -1));

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Chicken Lollipop", "Hakka Noodles", "Cheesecake", "Lasagne", "Nachos", "Ice Cream" }));
        jComboBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBox1ActionPerformed(evt);
            }
        });
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 50, -1, -1));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 120, 100, -1));
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 160, 100, -1));
        ...
        jLabel5.setText("Update Item Details");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new Item().setVisible(true); //Making Item visible
    ...
    /* Update Button
    To update row(s) in Restaurant Table */
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //Retriving values from the respective components
        String cName = jComboBox1.getSelectedItem().toString();
        String cType = jTextField1.getText();
        int cPrice = Integer.parseInt(jTextField2.getText());
        ...
        try {
            ...
            if (cPrice > 0) {
                ...
                String query = "Update Restaurant set Type='" + cType + "',Price='" + cPrice + "' where Name= '" + cName + "';";
                //To update respective row
                stmt.executeUpdate(query);
                JOptionPane.showMessageDialog(this, "Record Updated Successfully."); //display message
            } else {
    ...
    /* Search Button
    Searh the item to be updated */
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        //Setting the text fields to editable so the user can modify the necessary details
        jTextField1.setEditable(true);
        jTextField2.setEditable(true);
        //Retriving the selected item
        String cName = jComboBox1.getSelectedItem().toString();
        //try clause
        try {
            Class.forName("java.sql.DriverManager"); //loading driver class
            ...
            Statement stmt = (Statement) con.createStatement();
            //SQL statement to be executed
            String query = "select * from Restaurant where Name= '" + cName + "';";
